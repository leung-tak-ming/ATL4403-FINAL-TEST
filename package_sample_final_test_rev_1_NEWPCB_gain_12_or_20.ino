...
//Temperature = 30.00 C
//                     low freq high freq 
//Busvoltage_75k  200k  14.976  15.008
//Buscurrent_75k  200k  37.139  20.170
//Vddvoltage_75k  200k  6.016   6.024
//Vddcurrent_75k  200k  69.200  29.200
//Gain 75k        200k  1.491   1.030
//RAW Gain 75k    200k  1.19    0.94
//RAW Phase 75k   200k  1.19    1.32
//V_INT 75k       200k  5.8880  5.8880
//VREF 75k        200k  1.2520  1.2500       
//--------------------------------------

//-----------gain =1.2------------------
//Temperature = 30.00 C
//Busvoltage_75k  200k  15.000  15.016
//Buscurrent_75k  200k  28.494  17.929
//Vddvoltage_75k  200k  5.992   5.992
//Vddcurrent_75k  200k  49.200  24.800
//Gain 75k        200k  1.376   1.009
//RAW Gain 75k    200k  1.14    0.93
//RAW Phase 75k   200k  1.24    1.13
//V_INT 75k       200k  5.8880  5.8800
//VREF 75k        200k  1.2300  1.2300
//------------------------------------
//select the ATL3304 or ATL3302
#define ATL3304
//#define ATL3304

#if defined(ATL3304)
#define current_avg    37.1      //set the 
#define current_vdd    69.2 

#elif defined(ATL3302)
...
// gain =2 VDD currnet 28.4mA and 18.4mA
// gain =2 VDDH currnet 50mA and 31.6mA
// gain =1.2 vddh
// gain =1.2
...
#define freq_low   100000    //75k  set freq Low 29mA@Gain =2 
//---------------------------------------------------------------------------
...
void measure() {
  ina3221.wireWriteRegister(INA3221_REG_CONFIG, INA3221_CONFIG_RESET);
...
{ RESET_INA3221_BUFF();
  ...
  current_mA = ina3221.getCurrent_mA(1) * busoffsetcurrent; ;   //VDDH current
...
void RESET_INA3221_BUFF()
{ ina3221.wireWriteRegister(INA3221_REG_CONFIG, INA3221_CONFIG_RESET);
  ina3221.INA3221SetConfig();
  delay(10);

}
void RESET_INA3221A_BUFF()
{ ina3221a.wireWriteRegister(INA3221_REG_CONFIG, INA3221_CONFIG_RESET);
  ina3221a.INA3221SetConfig();
  delay(200);
